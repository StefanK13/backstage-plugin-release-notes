  ...
  return (
    <Grid container>
      <Grid item xs={12} md={3}>
        {
          selectedRelease && 
          <InfoCard title="Releases" className={classes.infoCard} noPadding>
            <MenuList className={classes.menuList}>
              {releases.map((release) => {
                let isSelected = selectedRelease.tag_name === release.tag_name;

                return (
                  <MenuItem className={classes.menuItem} selected={isSelected} onClick={() => setSelectedRelease(release)}>
      ...
      <Grid item xs={12} md={9}>
        {
          ...
          <InfoCard title={selectedRelease.name}>
            <MarkdownContent content={selectedRelease.description} dialect='common-mark' />
          </InfoCard>
        }
      </Grid>
    </Grid>
